...
public class SystemDaoImpl {
    ...
    public void go() {
        ...
        System.out.println("Hello dear user!  Please enter the number that corresponds to your desired action.");
        while(true) {
                ...
                case 1:
                    ...
                    while (pendingList.hasNext()) {
                        ...
                        if (input == 1) {
                            ...
                            app.setApprovalState("approved");
                        } else if (input == 2) {
                            app.setApprovalState("denied");
                        } else {
